...
public class Parameters {
	...
	public final static Path transactionsMapInverse = artifacts.resolve("transactions.inverse.map");
	...
	public final static long logInterval = 5;
	public final static TimeUnit logTimeUnit = TimeUnit.MINUTES;

	/* public final static long WRITE_BUFFER_SIZE = 36 * SizeUnit.GB;
