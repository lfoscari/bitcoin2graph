...
because is very difficult to avoid adding duplicate arcs, and this slow down
...
references a previous.  AFAIK Bitcoinj does not allow reverse loading, but
another solution might be found.
...
- Try to find out why the ArrayList graph and the Iterator graph are different
