...
2. Run DownloadInputsOutputs to download the inputs and outputs, remove
   unnecessary data, compute the bloom filters and build a map from addresses to
   longs. You can also pass the path to a directory to use local raw inputs and
   outputs.
